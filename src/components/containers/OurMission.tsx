              ...
              <div className="row gaper align-items-center">
                ...
                <div className="col-12 col-lg-7 col-xxl-5 offset-xxl-2">
                  <div className="text-center text-lg-start">
                    <p>
                      To empower entrepreneurs and buisnesses by providing
                      unparalleled branding,marketing,and funding solutions that
                      not only elevate their online presence but also pave the
